...
$query = "SELECT COUNT(*) as ErrorCount, MIN(DATA_IMPORTACAO) as FirstError, MAX(DATA_IMPORTACAO) as LastError FROM [dbo].[SPS_LOG_EDI] WHERE STATUS = 'Erro' AND CONVERT(DATE, DATA_IMPORTACAO) = '$Date'"
